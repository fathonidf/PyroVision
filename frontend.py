...
st.set_page_config(
    page_title="🔥 PyroVision AI - Fire Detection System",
    layout="wide",
...
# Header Section
st.markdown("# 🔥 PyroVision AI")
st.markdown('<p class="subtitle">🎯 Sistem Deteksi Kebakaran & Asap Real-Time dengan YOLOv11</p>', unsafe_allow_html=True)
...
with col_btn1:
    start_stream = st.button("▶️ START", type="primary", use_container_width=True)
with col_btn2:
    stop_stream = st.button("⏸️ STOP", use_container_width=True, disabled=not st.session_state.streaming)
